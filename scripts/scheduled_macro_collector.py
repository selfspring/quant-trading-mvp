import sys
import io
if hasattr(sys.stdout, str(chr(39))+str(chr(98))+str(chr(117))+str(chr(102))+str(chr(102))+str(chr(101))+str(chr(114))+str(chr(39))):
    sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding=str(chr(39))+str(chr(117))+str(chr(116))+str(chr(102))+str(chr(45))+str(chr(56))+str(chr(39)), errors=str(chr(39))+str(chr(114))+str(chr(101))+str(chr(112))+str(chr(108))+str(chr(97))+str(chr(99))+str(chr(101))+str(chr(39)))
"""
宏观数据定时采集脚本
